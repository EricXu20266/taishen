...
- **taishen_setup_1.7.2.exe** — Windows installer (recommended)
- **taishen_1.7.2.zip** — Windows portable, extract and run
- **taishen_1.7.2_macOS_arm64.dmg** — macOS Apple Silicon (M1-M4) installer
