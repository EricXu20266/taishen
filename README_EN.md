...
**Eric Xu · Vibe Coding** | v1.4.6 | 2026
...
- **taishen_setup_1.4.6.exe** — Windows installer (recommended)
- **taishen_1.4.6.zip** — Windows portable, extract and run
- **taishen_1.4.6_macOS_arm64.dmg** — macOS Apple Silicon (M1-M4) installer
