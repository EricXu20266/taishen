...
- **taishen_setup_1.6.4.exe** — Windows installer (recommended)
- **taishen_1.6.4.zip** — Windows portable, extract and run
- **taishen_1.6.4_macOS_arm64.dmg** — macOS Apple Silicon (M1-M4) installer
