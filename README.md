...
**二班的Eric · Vibe Coding 作品** | v1.0.3 | 2026

---

面向知识工作者的 AI 智能体桌面客户端，针对 DeepSeek 深度特调。

核心理念：**从信息到成果**——将你的资料和想法直接转化为可交付的结构化产出（报告、论文、PPT、数据分析），而非仅仅聊天。
...
### 安装
- **taishen_setup_1.0.3.exe** — Windows 安装包（推荐）
...
| 文件 | SHA256 |
|------|--------|
| taishen_setup_1.0.3.exe | `58EFB479EF0E7901963BA35A8488B768CD56994178EEE9BEC2A4C1D995C2A7C9` |
| taishen1.0.3免安装包.zip | `85019FAFFEA0BCD5C27874DEC4B075113CF19AD1484FF38FF09CCC58BE200D80` |
